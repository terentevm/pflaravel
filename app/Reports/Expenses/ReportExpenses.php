...
use App\Repositories\ReportExpensesRepository as Repo;
use Illuminate\Support\Facades\Auth;

class ReportExpenses extends ReportAbstract
{
    ...
    public function execute()
    {
        ...
        $data = $this->byPeriod === true
            ? (new ExpensesByPeriod($this->details))->execute($dbResult)
            : (new FlatExpenses($this->details))->execute($dbResult);
